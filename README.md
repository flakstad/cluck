...
- completion is explicit: press `TAB` after an alias prefix like `str/` to complete from the imported Cluck namespace; ordinary typing does not trigger completion
