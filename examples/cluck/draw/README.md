...
- extracted draw helper namespaces under `src/cluck/examples/draw/`, including state, history, view, panel, geometry, selection, actions, canvas, render, status, commands, replay, edit, create, stroke, and input
